...
* Two po-files need to be translated: [default.po](https://github.com/foodcoopshop/foodcoopshop/tree/main/resources/locales/en_US/default.po) and [cake.po](https://github.com/foodcoopshop/foodcoopshop/tree/main/resources/locales/de_DE/cake.po) (just the translated parts for cake.po)
