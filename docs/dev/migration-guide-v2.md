...
* If you want to use the new single sign on for discourse forums, set `app.discourseSsoEnabled` to `true` and add a `app.discourseSsoSecret`. [Anleitung auf Deutsch](/diverses/sso-fuer-discourse-forum)

## FCS v2.2.x to FCS v2.3.x
* replace source code => see bottom of page
* execute migrations => see bottom of page
* Enable the [new cronjob handling](/dev/cronjobs)
...
* activate new cronjob "PickupReminder", see bottom of [installation guide](/dev/installation-guide)
...
* if you have problems with the update, [please create a new issue](https://github.com/foodcoopshop/foodcoopshop/issues/new)
...
* replace source code => see bottom of page
* use the new structure of config files (rename custom.config.php to custom_config.php), follow the steps in the updated [Installation guide](/dev/installation-guide)
...
* [I#330](https://github.com/foodcoopshop/foodcoopshop/issues/330), [I#518](https://github.com/foodcoopshop/foodcoopshop/issues/518)
* If you still have questions, [please create a new issue](https://github.com/foodcoopshop/foodcoopshop/issues/new).
