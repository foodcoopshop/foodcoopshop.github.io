...
* Jede beteiligte Foodcoop muss zur Verwendung des Netzwerk-Moduls immer die [aktuellste FoodCoopShop-Version](https://www.foodcoopshop.com/download) installiert haben und ein SSL-Zertifikat (https) verwenden.
...
![](/assets/img/de/netzwerk-modul/superadmin-remote-foodcoops-erstellen-1.png)
...
![](/assets/img/de/netzwerk-modul/hersteller-remote-foodcoops-auswaehlen-1.png)
...
![](/assets/img/de/netzwerk-modul/produktdaten-synchronisieren-vorschau-1.png)
...
* Achtung: Das Anmelden bei den Remote-Foodcoops über das Netzwerk-Modul erlaubt leider **keine Sonderzeichen im Passwort**. Falls das der Fall ist, muss es bei der Remote-Foodcoop geändert werden.
...
![](/assets/img/de/netzwerk-modul/produkte-zuordnen-1.png)
