...
Seit der Version 2.1 können Mitgliedskonten gelöscht werden. Jedes Mitglied kann das für das eigene Mitgliedskonto machen, Superadmins können auch andere Mitgliedskonten löschen. In der Mitglieder-Liste im Admin-Bereich kann der kumulierte Waren- bzw. Pfandwert von den Guthaben-Konten gelöschter Mitglieder eingesehen werden, indem man den Filter oben links auf "gelöscht stellt".
